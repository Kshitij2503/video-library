...
<input type="submit" name ="submit3" value="Submit1" id="butt"><br>
</form>
...
<center><H1 style="color:white;text-align:center">RENTED VIDEO DETAILS </H1></center>

<?php
$con = mysqli_connect("localhost","root","","library");
$query1="SELECT * FROM rented_videos ";
